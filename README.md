...
```
├── _assets       # Assets used in the documentation
├── Systems       # Technical documentation of our internal systems
├── Templates     # Templates for the shape of this documentation
└── README.md
```
